...
public class App {
    ...
    public static void main(String[] args) {
        ...
        /*
                 ...
                 * 
                 * El framework de Colecciones, Es un conjunto de Interefaces, con metodos
        ...
        // Colleccion que admite personas y todos los que hereden
        // de Persona, por ejemeplo Estudiante, Trabajador
        // (Generics)
        // https://docs.oracle.com/javase/tutorial/extra/generics/index.html

        /* Breve explicaciones, un poco mas profunda de la Genericidad */
        // La siguiente coleccion admitiria elementosde caulquier tipo
        ...
        // limite.
        // Por tanto, si queremos tener una coleccion que admita Personas y todos
        ...
        /*
                 ...
                 * metodos estaticos de la propia interface, lo cual genera una lista
        ...
        /*
                 * Recorrer una colecciones (Travesing Collections)
                 * 
                 ...
                 * 
                 * 3. La FORMA SUGERIDA (RECOMENDADA). Utilizando Opercaiones de Agregado
                 * (Metodos
                 * de la clase Stream, las expresiones Lambda y los Metodos por referencia)
         */

 /*
                 * Utilizando un iterador(Interface Iterator), vamos a recorrer la coleccion de
                 * personas2, para eliminar
         ...
         * promediode las becas otorgadas a los estudiantes.
         * 
